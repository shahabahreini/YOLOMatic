---
description: Development setup, testing, style, commit conventions, and pull request guidance for YOLOmatic contributors.
---
...
- 📜 [Code of Conduct](https://github.com/shahabahreini/YOLOMatic/blob/main/CODE_OF_CONDUCT.md)
...
5. Use the [PR template](https://github.com/shahabahreini/YOLOMatic/blob/main/.github/PULL_REQUEST_TEMPLATE.md) — it asks the right questions.
...
Please do **not** open a public issue for security vulnerabilities. See [SECURITY.md](https://github.com/shahabahreini/YOLOMatic/blob/main/SECURITY.md) for the private disclosure process.

## License

By contributing you agree your work is licensed under [Apache 2.0](https://github.com/shahabahreini/YOLOMatic/blob/main/LICENSE.md).
